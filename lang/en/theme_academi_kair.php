...
$string['configtitle'] = "academi_kair Settings";
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="academi_kair/pix/screenshot.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Moodle academi_kair theme</h3><p>This theme is based on the Boost Moodle theme.</p><p>Authors: LMSACE Dev Team<br>Contact: info@lmsace.com<br>Website: <a href="http://www.lmsace.com">www.lmsace.com</a><br></p>';

$string['configtitle'] = 'academi_kair';
...
$string['pluginname'] = 'academi_kair';
...
-Moodle development|https://moodle.org/development
Moodle.com|http://moodle.com/";
$string['privacy:metadata'] = 'The academi_kair theme does not store any personal data about any user.';
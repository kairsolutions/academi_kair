...
$html = theme_academi_kair_get_html_for_settings($OUTPUT, $PAGE);
if (right_to_left()) {
...
<head>
    ...
    <link rel="shortcut icon" href="https://ainalab.kz/css/m_icon.ico" />
...
<?php
    ...
    require_once(dirname(__FILE__) . '/includes/header2.php');
?>
<!--=========== Slideshow section start here ===========-->
<div>
<?php
    $toggleslideshow = theme_academi_kair_get_setting('toggleslideshow');
